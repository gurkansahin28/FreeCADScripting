...
Wed Nov 13 05:37:25 PM +03 2024
...
# bottom radius
selectedObj.Radius1 = 0 # bottom radius
selectedObj.Radius2 = 4 # top radius
...
howManyTimes = 0
while howManyTimes < 8:
    input('Press Enter to increase bottom radius!..')
    howManyTimes += 1
    # Radius1 and Radius2 shouldn't be equal
    if howManyTimes == selectedObj.Radius2: continue
    selectedObj.Radius1 = howManyTimes
    doc.recompute()
