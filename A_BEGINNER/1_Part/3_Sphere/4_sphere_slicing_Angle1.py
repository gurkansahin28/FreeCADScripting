...
specificDocName = 'PartSphereSlicingAngle1Doc'
...
slicingAngle1 = Units.Quantity(selectedObj.Angle1, Units.Angle)
...
while howManyTimes > 0:
    ...
    howManyTimes -= 1
    slicingAngle1 += Units.Quantity(18, Units.Angle)  # Ensure 36 is treated as degrees
    selectedObj.Angle1 = slicingAngle1.Value  # Extract numeric value to assign
    doc.recompute()
