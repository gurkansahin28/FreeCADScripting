...
specificDocName = 'PartSphereSlicingAngle2Doc'
...
# Convert the slicingAngle2 to a FreeCAD quantity (degree unit)
slicingAngle2 = Units.Quantity(selectedObj.Angle2, Units.Angle)
...
while howManyTimes > 0:
    ...
    howManyTimes -= 1
    slicingAngle2 -= Units.Quantity(18, Units.Angle)  # Ensure 36 is treated as degrees
    selectedObj.Angle2 = slicingAngle2.Value  # Extract numeric value to assign
    doc.recompute()
